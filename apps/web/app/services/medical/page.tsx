    ...
    <>
      ...
      <Section className="bg-muted/30">
        <div className="mx-auto max-w-3xl">
          <RevealOnScroll>
            <span className="text-xs font-medium uppercase tracking-[0.2em] text-brand-teal">What&apos;s included</span>
            <h2 className="mt-4 text-2xl font-semibold">Full-service delivery</h2>
